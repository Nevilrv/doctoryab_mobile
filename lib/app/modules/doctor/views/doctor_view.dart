                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style:
                                                AppTextTheme.b(11).copyWith(color: AppColors.primary.withOpacity(0.5)),
                                          ),
                                        ],
                                      ),
                                    ),
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        Utils.openGoogleMaps(
                                                            controller.doctor?.geometry?.coordinates[1] ?? 0.0,
                                                            ...
                                                            GestureDetector(
                                                              onTap: () {
                                                                ...
                                                                controller.addDocFeedback(
                                                                    doctorId: controller.doctor.datumId.toString(),
                                                                    context: context);
                                                              },
                                                              child: Container(
                                                                decoration: BoxDecoration(
