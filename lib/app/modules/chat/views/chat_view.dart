                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              msg.documents.isEmpty
                                                  ? SizedBox()
                                                  : GestureDetector(
                                                      onTap: () {
                                                        openFile(
                                                            "${ApiConsts.hostUrl}${msg.documents[0]}");
                                                      },
                                                      child: Center(
                                                        child: Icon(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (controller.audioPlayer1.state ==
                                                                          ...
                                                                          controller
                                                                              .audioPlayer1
                                                                              .pause();
                                                                        } else if (controller.audioPlayer1.state == ap.PlayerState.paused ||
                                                                            controller.audioPlayer1.state ==
                                                                                ap.PlayerState.stopped) {
                                                                          controller
                                                                              .play1(
                                                                            path:
                                                                                "${ApiConsts.hostUrl}${msg.voiceNotes[0]}",
                                                                          )
                                                                              .then((value) {
                                                                            controller.isPause1 =
                                                                                false;
                                                                            controller.update();
                                                                            controller.timers1 =
                                                                                Timer.periodic(Duration(milliseconds: controller.duration1.inMilliseconds.round() ~/ controller.voiceTrackRowSize), (timer) {
                                                                              log('{timer.tick}${timer.tick}');
                                                                ...
                                                                children: [
                                                                    GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        controller.current1 =
                                                                            -1;
                                                                        controller.voiceTrackRowSize = controller
                                                                            .hi
                                                                            .length;
                                                                        controller
                                                                            .audioPlayer1
