    ...
    return Padding(
      ...
      child: RefreshIndicator(
        ...
        child: SingleChildScrollView(
            ...
            child: GetBuilder<DrugStoreController>(
              builder: (controller) {
                return Column(
                  children: [
                    Padding(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                    color: AppColors.red3, width: controller.is24HourSelected == false ? 1 : 2),
                                borderRadius: BorderRadius.circular(10),
                              ),
                              child: Padding(
                              ...
                              Row(
                                ...
                                children: [
                                  RatingBar.builder(
                                    ...
                                    itemSize: 17,
                                    initialRating:
                                        double.parse("${item.averageRatings == null ? "0.0" : item.averageRatings}"),
                                    // minRating: 1,
                                    direction: Axis.horizontal,
                                    allowHalfRating: true,
                                    itemCount: 5,
