                                ...
                                children: [
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            Text(
                                              SettingsController.appLanguge == 'English'
                                                  ? "${DateFormat('EE, dd MMM yyyy').format(DateTime.parse(controller.pregnancyData!.conceptionDate.toString()))}"
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              SettingsController.appLanguge == 'English'
                                                  ? "${DateFormat('EE, dd MMM yyyy').format(DateTime.parse(controller.pregnancyData!.dueDate.toString()))}"
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Image.network(
                                          ApiConsts.hostUrl + controller.pregnancyData!.ptModules![controller.weekCount].img.toString(),
                                          height: h * 0.21,
                                        ),
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                SettingsController.appLanguge == 'English'
                                                    ? controller.pregnancyData!.ptModules![controller.weekCount].sizeEnglish ?? "None"
                                                    : SettingsController.appLanguge == 'پشتو'
                                                        ? controller.pregnancyData!.ptModules![controller.weekCount].sizePashto ?? "None"
                                                        : controller.pregnancyData!.ptModules![controller.weekCount].sizeDari ?? "None",
                                                style: TextStyle(
                                                  color: AppColors.black,
                                                  fontWeight: FontWeight.w700,
                                                ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                SettingsController.appLanguge == 'English'
                                                    ? controller.pregnancyData!.ptModules![controller.weekCount].weightEnglish ?? "None"
                                                    : SettingsController.appLanguge == 'پشتو'
                                                        ? controller.pregnancyData!.ptModules![controller.weekCount].weightPashto ?? "None"
                                                        : controller.pregnancyData!.ptModules![controller.weekCount].weightDari ?? "None",
                                                style: TextStyle(
                                                  color: AppColors.black,
                                                  fontWeight: FontWeight.w700,
                                                ),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                SettingsController.appLanguge == 'English'
                                                    ? controller.pregnancyData!.ptModules![controller.weekCount].lengthEnglish ?? "None"
                                                    : SettingsController.appLanguge == 'پشتو'
                                                        ? controller.pregnancyData!.ptModules![controller.weekCount].lengthPashto ?? "None"
                                                        : controller.pregnancyData!.ptModules![controller.weekCount].lengthDari ?? "None",
                                                style: TextStyle(
                                                  color: AppColors.black,
                                                  fontWeight: FontWeight.w700,
                                                ),
