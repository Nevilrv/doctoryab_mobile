        ...
        body: Stack(
          children: [
            ProfileViewNew(
              ...
              numberOfusersRated: item?.totalFeedbacks == null ? 0 : int.parse(item!.totalFeedbacks.round().toString()),
              reviewFunction: () {
                                  ...
                                  controller.productList.isEmpty
                                      ...
                                      : GridView.builder(
                                          ...
                                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                              crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 9, mainAxisExtent: h * 0.27),
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child: CachedNetworkImage(
                                                          imageUrl: "${ApiConsts.hostUrl}${controller.productList[index].img}",
                                                          fit: BoxFit.cover,
                                                          placeholder: (_, __) {
                                                            return Image.asset(
                                                    ...
                                                    Text(
                                                      ...
                                                      style: AppTextStyle.boldPrimary11.copyWith(color: AppColors.primary.withOpacity(0.5)),
                                                    ),
                                                    Spacer(),
                                                    Container(
                                                      decoration: BoxDecoration(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        ...
                                                                        style:
                                                                            AppTextStyle.boldBlack13.copyWith(fontWeight: FontWeight.w400),
                                                                      ),
                                                                    ],
                                                                  ),
                                                                ),
                                                            ...
                                                            GestureDetector(
                                                              onTap: () {
                                                                controller.addDocFeedback(
                                                                    pharmacyId: item!.id.toString(), context: context);
                                                              },
                                                              child: Container(
                                                                decoration: BoxDecoration(
